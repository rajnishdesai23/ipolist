      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/ipo/mainboard"
              className="px-3 py-1.5 rounded-xl text-xs font-medium bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border border-blue-200"
            >
              Mainboard Only
            </Link>
            <Link
              href="/ipo/sme"
              className="px-3 py-1.5 rounded-xl text-xs font-medium bg-purple-50 text-purple-700 dark:bg-purple-950 dark:text-purple-300 border border-purple-200"
            >
              SME Only
            </Link>
          </div>
        ...
        {/* Full Interactive IPO Directory with Sticky Filter & Grid/Table Modes */}
